...
export const getTicketSchema = {
  ticket: z
    .string()
    .describe(
      "Freshdesk ticket URL or ticket ID. Examples: 'https://company.freshdesk.com/a/tickets/12345' or '12345'"
    ),
};
...
): Promise<{ context: TicketContext; formatted: string }> {
...
function formatTicketContext(ctx: TicketContext): string {
  const lines: string[] = [];
