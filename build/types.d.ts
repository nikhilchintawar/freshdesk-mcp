...
export declare const TICKET_STATUS: Record<number, string>;
export declare const TICKET_PRIORITY: Record<number, string>;
export declare const TICKET_SOURCE: Record<number, string>;
